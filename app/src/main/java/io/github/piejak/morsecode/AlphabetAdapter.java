...
/**
 * Created by Brian on 12/18/2015.
 */
public class AlphabetAdapter extends RecyclerView.Adapter<AlphabetAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView morseTextView;

        public ViewHolder(View v) {
            super(v);
            letterTextView = (TextView) v.findViewById(R.id.letter);
            morseTextView = (TextView) v.findViewById(R.id.morseLetter);
        }
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.letterTextView.setText(mDataset[position]);
